...
(function (global) {
  ...
  const CAPACIDADES = [
    ...
    { id:'autonomia', nome:'Independência', fator:'D',
    ...
    { id:'competitividade', nome:'Dinamismo', fator:'D',
    ...
    // ── INFLUENTE (I) ──
    { id:'expressividade', nome:'Extroversão', fator:'I',
    ...
    { id:'entusiasmo', nome:'Entusiasmo e motivação', fator:'I',
    ...
    { id:'articulacao', nome:'Sociabilidade', fator:'I',
    ...
    { id:'adaptabilidade', nome:'Flexibilidade com mudanças', fator:'I',
    ...
    // ── ESTÁVEL (S) ──
    { id:'escuta', nome:'Empatia', fator:'S',
    ...
    { id:'serenidade', nome:'Paciência', fator:'S',
    ...
    { id:'constancia', nome:'Persistência', fator:'S',
    ...
    { id:'cooperacao', nome:'Conciliação e consentimento', fator:'S',
    ...
    { id:'apoio', nome:'Apoio e disponibilidade', fator:'S',
    ...
    { id:'previsibilidade', nome:'Estabilidade', fator:'S',
    ...
    // ── ANALÍTICO (C) ──
    { id:'rigor', nome:'Racionalidade', fator:'C',
    ...
    { id:'detalhe', nome:'Detalhismo', fator:'C',
    ...
    { id:'metodo', nome:'Organização e controle', fator:'C',
    ...
    { id:'cautela', nome:'Prudência', fator:'C',
